        ...
        if int(menu_category) in menu_items.keys():
            ...
            if menu_selection.isdigit():
                ...
                if menu_selection in menu_items.keys():
                    ...
                    print("Quantity will default to 1 if input is invalid.")
                    quantity=input(f"Type quantity of {item_name}: ")
                    ...
                    print(f"{menu_selection} was not valid.")
            else:
...
for order in order_list:
    ...
    num_item_spaces1 = 25 - len(item_name)
    num_item_spaces2 = 5 - len(str(price))
    ...
    print(f"{item_name}{item_spaces1}"
        + f" | ${price}{item_spaces2}"
        + f" | {quantity}")

# 11. Calculate the cost of the order using list comprehension
# Multiply the price by quantity for each item in the order list, then sum()
# and print the prices.
price_product=[order["Price"]*order["Quantity"] for order in order_list]
